...
Responsibilities:
1. Run setup commands to prepare the environment
2. Send user messages to the Agent turn by turn
3. Handle mock injection (benchmark-mock plugin)
4. Collect audit logs and token statistics
5. Invoke the Judge for evaluation
