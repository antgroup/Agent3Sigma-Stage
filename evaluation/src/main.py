"""Main entry point: config loading, data grouping, multiprocess scheduling, result merging, report generation"""
...
def main(config_path: str = "config.yaml") -> None:
    ...
    # Collect results while running and save in real time
    ...
    # Collect the last results enqueued before workers exit
    for p in processes:
        p.join(timeout=5)
    _collect_and_save()
    ...
    # Final save + generate HTML report
    save_results(all_results, output_dir, num_runs)
